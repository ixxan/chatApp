...
/**
 * A type-narrowed IDataPacketData, denoting a message that can be sent to an IReceiver. 
 * 
 * @author Design Group J
 *
 */
public interface IReceiverMsg extends IDataPacketData {
	...
	public static IDataPacketID GetID() {
		return DataPacketIDFactory.Singleton.makeID(IReceiverMsg.class);
	}
